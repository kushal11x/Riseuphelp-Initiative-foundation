...
export const GALLERY_ITEMS: GalleryItem[] = [
  ...
  },
  {
    ...
    image: "/uploads/slum_children_tiffin_distribution.jpg",
    images: [
    ...
    summary: "Serving hot, healthy, and wholesome meal tiffins, fresh bananas, and stationery kits alongside foundational classroom education for underprivileged slum children in Jaipur.",
    fullStory: "On Wednesday, September 9, 2026, Rise Up Help Initiative Foundation organized its scheduled Class 6 Slum Education & Nutrition Drive in Jaipur. Dedicated volunteer mentors conducted classroom lessons on whiteboard while distributing freshly prepared nutritious meal tiffins, bananas, and academic stationery supplies to children from underprivileged slum communities. Proper nutrition combined with free education ensures every child has the strength, focus, and dignity to study and build a brighter future.",
    impactMetrics: "100% wholesome hot tiffin meals, fruits & stationery delivered directly into children's hands.",
