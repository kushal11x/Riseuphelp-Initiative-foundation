...
export const INITIAL_SEVA_SCHEDULE: SevaScheduleEvent[] = [
  {
    ...
    status: "active_today",
    description: "Today's sacred Jaljhulani Ekadashi live bedside 100% pure cold-pressed pomegranate (taaza anaar) juice distribution for cancer chemotherapy patients across RUHS wards to restore hemoglobin and platelets. Rate: ₹70 per glass. Timing: 12:00 PM - 04:00 PM.",
  ...
  },
  {
    ...
    sevaItems: ["🥥 Fresh Tender Coconut Water"],
  },
  {
