...
export const INITIAL_SEVA_SCHEDULE: SevaScheduleEvent[] = [
  {
    ...
    status: "active_today",
    description: "Today's sacred Jaljhulani Ekadashi live bedside seva: fresh green tender coconuts + pure cold-pressed pomegranate (taaza anaar) juice for cancer chemotherapy patients across RUHS wards. Timing: 12:00 PM - 04:00 PM.",
